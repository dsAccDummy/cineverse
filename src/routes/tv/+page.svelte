<script lang="ts">
  ...
  import { tvGenres } from '$lib/stores/genres';
  import { TV_SORT_OPTIONS, type TVShow, type Genre } from '$lib/types/tmdb';
  ...
  async function loadShows(resetPage = false) {
...
<svelte:head>
  ...
  <meta name="description" content="Browse and discover TV shows. Filter by genre, year, and sort by popularity, rating, and more." />
</svelte:head>
...
<div class="pt-20 pb-12">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
      <div>
        <h1 class="text-3xl md:text-4xl font-bold">TV Shows</h1>
    ...
    <div class="flex flex-wrap gap-3 mb-8">
      ...
      <select
        ...
        aria-label="Sort by"
      >
        {#each TV_SORT_OPTIONS as option}
      ...
      {#if selectedGenre || selectedYear || selectedSort !== 'popularity.desc'}
        <button
          type="button"
          onclick={() => { selectedGenre = ''; selectedYear = ''; selectedSort = 'popularity.desc'; loadShows(true); }}
